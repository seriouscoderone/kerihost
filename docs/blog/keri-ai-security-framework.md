# How KERI + AI Frameworks Will Transform Security

**Status:** Draft outline

**Theme:** KERI's cryptographic accountability combined with AI agent frameworks creates a security model that eliminates most traditional threat vectors.
