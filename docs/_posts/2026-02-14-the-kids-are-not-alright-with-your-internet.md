---
title: "The Kids Are Not Alright with Your Internet"
date: 2026-02-14
categories: [philosophy, community]
tags: [gen-z, authenticity, dumb-phones, social-media, community, relationships, identity, nostalgia, digital-detox]
...
**Bots pretending to be people.** We wrote about this in [Follow People, Not Platforms](/blog/2026/02/13/follow-people-not-platforms/) — half of social media engagement isn't human. Young people can feel it even when they can't articulate it. The conversations feel hollow because many of them literally are.
...
**Verified identity.** You need to know that the person you're talking to is real. Not a bot. Not a sock puppet. Not an algorithm wearing a human face. This is exactly what KERI identifiers provide — [cryptographic proof that a person is who they claim to be](/blog/2026/02/11/why-digital-identity/), without a platform vouching for them.
...
**Communication that isn't surveilled.** When every message is mined for ad targeting, you self-censor. You perform. Authenticity requires privacy — not because you have something to hide, but because [you can't be real when you're always being watched](/blog/2026/02/06/data-at-the-edge/).

**Consent that means something.** Every app on your phone extracted your "consent" through a wall of legalese you never read. That's not consent. That's [a hostage negotiation dressed up as a checkbox](/blog/2026/02/13/accept-these-terms-or-what/).
...
**Real relationships, not algorithmic connections.** When you interact with someone through KERI-native infrastructure, you know they're real. Your [community service attestations](/blog/2026/02/08/community-service-marketplace/) are signed by actual people. Your reputation is built on verified interactions, not likes from strangers (or bots).

**Real community, not engagement metrics.** Community built on KERI infrastructure is geographic, interest-based, or values-based — whatever you choose. But it's real. People attesting to each other's contributions. [Wealth measured in relationships](/blog/2026/02/14/money-is-people/), not followers.
...
**Related:** [Follow People, Not Platforms](/blog/2026/02/13/follow-people-not-platforms/) explores what social media looks like when you remove the algorithm. [Money Is People](/blog/2026/02/14/money-is-people/) explores what happens when community — not currency — is the basis of wealth.

{% comment %}TODO: Add data on dumb phone sales trends, Gen Z social media sentiment surveys, specific examples of KERI-native social interactions vs platform-mediated ones, and exploration of what a "no-algorithm community app" built on KERI infrastructure would actually look like{% endcomment %}
